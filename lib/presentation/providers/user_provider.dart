...
// Re-export firebaseUserProvider reference
final firebaseUserProvider = Provider<AsyncValue?>((ref) {
  // This is a placeholder; the actual provider is in auth_provider.dart
  return null;
});
